...
export default function GuestMeetGreet() {
  ...
  return (
    <div>
      <h1 className="page-title">Meet & Greet — Email Generator</h1>
      <p style={{ color: 'var(--text-secondary)', marginBottom: 16, fontSize: 14 }}>
        Seleziona gli ospiti e genera un testo email pronto per essere inviato alla società di Meet & Greet.
      </p>
